...
## Следующие шаги (после клонирования / пуша)

1. **Отправить изменения на GitHub** (если ещё не пушил):  
   `git push origin main`
2. **Сборка:** `./gradlew assembleDebug`
3. **Тесты:** `./gradlew test`
4. **Ручной прогон:** установка на Seeker → кошелёк → майнинг → апгрейд → задания → топ
