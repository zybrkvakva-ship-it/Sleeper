package com.seekerminer.app.ui.screen.upgrade
...
import com.seekerminer.app.LocalActivityResultSender
import com.seekerminer.app.data.local.SkrBoostItem
import com.seekerminer.app.data.local.UpgradeEntity
import com.seekerminer.app.ui.components.CyberCard
...
fun UpgradeScreen(
    ...
    Column(
        modifier = Modifier
            .fillMaxSize()
            .background(com.seekerminer.app.ui.theme.BgMain)
            .padding(16.dp)
        ...
        Text(
            ...
            color = com.seekerminer.app.ui.theme.CyberWhite
        )
        ...
        purchaseMessage?.let { msg ->
            Text(
                text = msg,
                fontSize = 12.sp,
                color = if (msg.startsWith("Буст") || msg.startsWith("Genesis")) com.seekerminer.app.ui.theme.CyberGreen else com.seekerminer.app.ui.theme.CyberYellow,
        ...
        Text(
            ...
            fontSize = 18.sp,
            fontWeight = FontWeight.Bold,
            color = com.seekerminer.app.ui.theme.CyberGreen
        )
        Spacer(modifier = Modifier.height(8.dp))
        Text(
            text = "Доступно: ${String.format("%,.2f", availableSkrRaw / 1_000_000.0)} SKR",
            fontSize = 14.sp,
            color = com.seekerminer.app.ui.theme.CyberGray
        )
        Spacer(modifier = Modifier.height(12.dp))
        ...
        Text(
            ...
            fontSize = 18.sp,
            fontWeight = FontWeight.Bold,
            color = com.seekerminer.app.ui.theme.CyberYellow
        )
        Spacer(modifier = Modifier.height(8.dp))
        val stats = userStats
        if (stats?.hasGenesisNft == true) {
            CyberCard(
                modifier = Modifier.fillMaxWidth(),
                strokeColor = com.seekerminer.app.ui.theme.CyberYellow,
                cornerRadius = 12.dp
            ) {
                Row(
                    modifier = Modifier
                ...
                Column(modifier = Modifier.padding(12.dp)) {
                    ...
                    Button(
                        ...
                        colors = ButtonDefaults.buttonColors(
                            containerColor = com.seekerminer.app.ui.theme.CyberYellow,
                            contentColor = BgMain,
...
private fun UpgradeCard(
    ...
    com.seekerminer.app.ui.components.CyberCard(
        modifier = Modifier.fillMaxWidth(),
        strokeColor = if (upgrade.isPurchased) com.seekerminer.app.ui.theme.CyberGreen else com.seekerminer.app.ui.theme.Stroke,
        cornerRadius = 12.dp
    ) {
        Row(
            modifier = Modifier
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    ...
                    fontSize = 18.sp,
                    fontWeight = FontWeight.Bold,
                    color = if (upgrade.isPurchased) com.seekerminer.app.ui.theme.CyberGray else com.seekerminer.app.ui.theme.CyberWhite
                )
                Spacer(modifier = Modifier.height(4.dp))
                Text(
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(
                    containerColor = com.seekerminer.app.ui.theme.CyberGreen,
                    contentColor = com.seekerminer.app.ui.theme.BgMain,
                    disabledContainerColor = com.seekerminer.app.ui.theme.CyberGray,
                    disabledContentColor = com.seekerminer.app.ui.theme.BgMain
                ),
                shape = RoundedCornerShape(12.dp)
            ) {
                Text(
