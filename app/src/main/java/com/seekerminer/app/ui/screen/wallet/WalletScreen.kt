    ...
    Column(
        ...
        if (walletState.connectedAddress == null) {
            com.seekerminer.app.ui.components.CyberButton(
                ...
                strokeColor = com.seekerminer.app.ui.theme.CyberGreen
            )
            ...
            walletState.error?.let { error ->
                ...
                Text(
                    text = error,
                    color = com.seekerminer.app.ui.theme.CyberRed,
                    fontSize = 14.sp,
            ...
            com.seekerminer.app.ui.components.CyberCard(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    TextButton(
                        ...
                        Text("Отключить", color = com.seekerminer.app.ui.theme.CyberRed)
                    }
                }
            }
            ...
            if (walletState.claimStatus is ClaimStatus.Success) {
                AlertDialog(
                    ...
                    text = {
                        Column {
                            Text("Ваши SKR Points подписаны wallet'ом!")
                            Spacer(modifier = Modifier.height(8.dp))
                            Text(
                    ...
                    confirmButton = {
                        TextButton(onClick = { viewModel.clearClaimStatus() }) {
                            Text("OK", color = com.seekerminer.app.ui.theme.CyberGreen)
                        }
                    }
                )
            }
        ...
        com.seekerminer.app.ui.components.CyberCard(
            modifier = Modifier.fillMaxWidth(),
            strokeColor = com.seekerminer.app.ui.theme.Stroke,
            cornerRadius = 12.dp
        ) {
            Column(modifier = Modifier.padding(16.dp)) {
