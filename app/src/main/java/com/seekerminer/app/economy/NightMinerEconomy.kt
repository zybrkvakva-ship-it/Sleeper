package com.seekerminer.app.economy

import com.seekerminer.app.utils.DevLog
import com.seekerminer.app.economy.boosts.NftBoost
import com.seekerminer.app.economy.boosts.SocialBoostCalculator
import com.seekerminer.app.economy.boosts.skrBoostPercent
import com.seekerminer.app.economy.models.NightContext
import com.seekerminer.app.economy.models.NightReward
import com.seekerminer.app.economy.rewards.BaseRewardCalculator
import com.seekerminer.app.economy.rewards.SleepDistributor
...
object NightMinerEconomy {
    ...
    fun calculateSkrBoostPotential(
        ctx: NightContext,
        targetLevel: com.seekerminer.app.economy.boosts.SkrBoostLevel
    ): Double {
...
fun NightContext.copy(
    ...
    skrBoostLevel: com.seekerminer.app.economy.boosts.SkrBoostLevel = this.skrBoostLevel,
